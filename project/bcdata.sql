...
CREATE TABLE IF NOT EXISTS `bc_usermeta`(
    `meta_id` BIGINT(20)UNSIGNED PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bc_terms`(
    `term_id` BIGINT(20)UNSIGNED PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `bc_posts`(
    `post_id` BIGINT(20)UNSIGNED PRIMARY KEY AUTO_INCREMENT,
...
/* 文章元数据表 */
CREATE TABLE IF NOT NULL EXISTS `bc_postmeta`(
    `meta_id` BIGINT(20)UNSIGNED PRIMARY KEY AUTO_INCREMENT,
...
/* 评论表 */
CREATE TABLE IF NOT NULL EXISTS `bc_comments`(
...
/* 评论元数据表 */
CREATE TABLE IF NOT NULL EXISTS `bc_commentmeta`(
    `meta_id` BIGINT(20)UNSIGNED PRIMARY KEY AUTO_INCREMENT,
...
/* 连接表 */
CREATE TABLE IF NOT NULL EXISTS `bc_links`(
    `link_id` BIGINT(20)UNSIGNED PRIMARY KEY AUTO_INCREMENT,
